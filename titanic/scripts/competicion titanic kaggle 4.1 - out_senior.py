...
df.drop(outliers_adulto_super.index, axis=0)
"""
...
df.adulto = pd.Categorical(df.adulto, categories=["joven", "adulto", "senior"])
dt.adulto = pd.Categorical(dt.adulto, categories=["joven", "adulto", "senior"])

cual_col.append("adulto")

"""
Haciendolo paso a paso, sin incluir los fillna en edades, parece que no necesito la variable senior
