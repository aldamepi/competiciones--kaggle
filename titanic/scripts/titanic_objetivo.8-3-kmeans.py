...
y_kmeans = kmeans.fit_predict(X_k)


### Visualización de los clusters
plt.scatter(X_k[y_kmeans == 0, 0], X_k[y_kmeans == 0, 1], s = 100, c = "red", label = "k1")
plt.scatter(X_k[y_kmeans == 1, 0], X_k[y_kmeans == 1, 1], s = 100, c = "blue", label = "k2")
plt.scatter(X_k[y_kmeans == 2, 0], X_k[y_kmeans == 2, 1], s = 100, c = "green", label = "k3")
plt.scatter(X_k[y_kmeans == 3, 0], X_k[y_kmeans == 3, 1], s = 100, c = "cyan", label = "k4")
...
#df_output.to_csv("../datasets/subm_am_py_RF.8-k2_220821.csv")

# 0.78708 el mejor resultado hasta ahora dentro del 3,5% mejor
# 0.77511 con kmeans sin categoricas
