...
classi_rna.add(Dense(units = 5, kernel_initializer = "uniform",  
                     activation = "relu", input_dim = 8))

### Añadir la segunda capa oculta
classi_rna.add(Dense(units = 5, kernel_initializer = "uniform",  activation = "relu"))
...
outRNA.to_csv('../datasets/subm_am_py_RNA-svar_100821.csv')
###### 0.75119
###### 0.77272 (sin variables adulto ni cubierta)
