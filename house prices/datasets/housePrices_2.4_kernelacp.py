...
# Reducir la dimensión del dataset con Kernel ACP
from sklearn.decomposition import KernelPCA
kpca = KernelPCA(n_components = 60, kernel="rbf")
X5_train = kpca.fit_transform(X5_train)
X5_test = kpca.transform(X5_test)
...
# 0.8595463
# 0.069718
#None 0.747577266441029
#120 #0.7722590557141761
#60 #0.7743891259769978
...
Submission.to_csv('HPPamengual_070921_kacp.csv')
